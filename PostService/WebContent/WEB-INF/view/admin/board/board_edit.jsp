...
<style>
@import "/PostService/css/index/index.css";

@import "/PostService/css/index/static.css";

@import "/PostService/css/board/board_edit.css";
</style>
</head>
<body>
		...
		<div class="main">
			<div class="main_content">
				...
				<div class="container_align">
					<div class="container">
						<form action="/PostService/admin/board/edit" method="post" enctype="multipart/form-data" name="edit_form">
						...
						<div class="board_btn">
							...
							<a href="/PostService/admin/index" class="btn">돌아가기</a>
						</div>
						</form>
					</div>
				</div>
