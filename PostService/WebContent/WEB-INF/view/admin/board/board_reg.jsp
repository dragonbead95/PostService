...
@import "/PostService/css/board/board_reg.css";
</style>
</head>
<body>
		...
		<div class="main">
			<div class="main_content">
				...
				<div class="container_align">
					<div class="container">
						<form action="/PostService/admin/board/reg" method="post" enctype="multipart/form-data">
						...
						<div class="write_container">
							...
							<a href="/PostService/admin/index" class="write_btn">취소</a>
						</div>
						</form>
					</div>
				</div>
