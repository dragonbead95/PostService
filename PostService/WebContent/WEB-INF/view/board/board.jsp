...
<div class="main_content">
	...
	<div class="board_search">
		<form action="/PostService/index" method="get">
			<fieldset>
	...
	<form action="/PostService/board/pub" method="post">
	<table class="board_table">
		...
		<tbody class="board_content">
			<c:forEach var="n" items="${list}">
				<tr>
					<td>${n.id}</td>
					<td><a href="/PostService/board/detail?id=${n.id}">${n.title}</a></td>
					<td>${n.writer_id}</td>
	...
	<div class="board_btn">
		<a href="/PostService/board/reg" class="btn">글쓰기</a>
	</div>
	</form>
	...
	<div class="board_page">
		...
		<c:forEach var="i" begin="0" end="4">
			<c:if test="${(startNum+i)<=lastNum}">
				<a href="/PostService/index?p=${startNum+i}"
