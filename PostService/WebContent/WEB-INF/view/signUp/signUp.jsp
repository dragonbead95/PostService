...
<title>SignUp</title>
<style>
@import "/PostService/css/index/header.css";
@import "/PostService/css/signUp/signUp.css";
...
<body>
	...
	<form action="/PostService/member/signUp" method="POST"
		...
		<div class="align_container">
			<div class="container">
				...
				<div class="register_btn_container">
					...
					<a href="/PostService/index" class="btn a_btn">취소</a>
				</div>

				<div class="signin">
					<p>
						이미 회원이신가요? <a href="/PostService/member/login">로그인</a>
					</p>
				</div>
